 ...
 * @author leoal
 */
public class ConsultaDono extends javax.swing.JDialog {

    private Cliente donoSelecionado;
    private ClienteTableModel model;
    private List<Cliente> listaDonos;
    
    public ConsultaDono(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public Cliente getDonoSelecionado() {
        return donoSelecionado;
    }
    
    public void setDonoSelecionado(Cliente donoSelecionado) {
    ...
    private void atualizaLista() {
        ...
        listaDonos = dao.findAll();
        model = new ClienteTableModel(listaDonos);
        jTableDono.setModel(model);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jTableDono);
    ...
    private void jButtonSelecionarPetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarPetActionPerformed
        setDonoSelecionado(
            model.getSelectedCliente(jTableDono, listaDonos)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaDono.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaDono dialog = new ConsultaDono(new javax.swing.JFrame(), true);
